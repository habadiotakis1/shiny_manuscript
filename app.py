...
app_ui = ui.page_fluid(
    ...
    ui.layout_columns(    
        # Formatting Options
        ui.card("Table - # Decimals", ui.input_numeric("decimals_table", 2, min=0, max=5),width="100%"),
        ui.card("P-Val - # Decimals", ui.input_numeric("decimals_pvalue", 3, min=0, max=5),width="100%"),
